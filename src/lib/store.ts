...
export const useDesktopStore = create<DesktopState>((set, get) => ({
  ...
  openWindow: (type, meta) => {
    ...
    const newWindow: WindowState = {
      id,
      type,
      title: type === "terminal" ? "Terminal" : type === "browser" ? (meta?.url ? new URL(meta.url).hostname : "Browser") : type === "setup" ? "Setup" : type === "auth" ? "Authentication" : type === "display" ? "Apps" : type === "xapp" ? "App" : "Settings",
      ...
      width: type === "auth" ? 440 : type === "xapp" ? 1024 : type === "display" ? 480 : DEFAULT_WIDTH,
      height: type === "auth" ? 360 : type === "xapp" ? 700 : type === "display" ? 200 : DEFAULT_HEIGHT,
      minimized: false,
      maximized: false,
      zIndex: nextZIndex,
      meta,
